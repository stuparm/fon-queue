...
<body>
	...
	<div class="col-md-9">
		<br /> <br /> <br /> Status: ${informationModel.status } <br />
		Sledeci redni broj: ${informationModel.nextOrdNumber} <br /> Student
		index: ${informationModel.nextStudentIndex} <br /> Duzina reda:
		${informationModel.queueSize} <br /> <br />
